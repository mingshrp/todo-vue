...
- I had an issue getting the project to run after initialization (`npm run dev`). I kept seeing the error **"vite: command not found"**. After re-reading the tutorial, I realized I had made a stupid mistake of forgetting to run `npm install` first.
...
![Iron Man Cat](https://i.pinimg.com/originals/77/21/3c/77213c0def52cad76f72037464622dfe.jpg)
